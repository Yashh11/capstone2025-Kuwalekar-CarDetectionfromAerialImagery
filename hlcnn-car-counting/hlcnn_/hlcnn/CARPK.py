...
#2D Gaussian Kernel to generate a normalised dist.
#density generation
#heatmap generation
...
#Custom PyTorch Dataset class for CARPK Dataset
class CARPK(data.Dataset):
    ...
    def __init__(self, root, set, train = True):
        ...
        #Loading image ids from txt file
    ...
    #rescale bounding boxes to match the resized dims
    ...
    #reads bounding box annotations from file
    ...
    def __getitem__(self, index):
        ...
        if gt_bbox.shape[0] > 0:
            #resize
            gt_boxes = np.asarray(self.resize_bbox(gt_bbox, (H, W), (o_H, o_W)), dtype=np.float32)
